...
* [Grab and Drag](https://addons.mozilla.org/ru/firefox/addon/grab-and-drag/) – прокрутка крупных изображений (и страниц) правой кнопкой мыши.
...
* [Zoom Page](https://addons.mozilla.org/ru/firefox/addon/zoom-page/) – возможность увеличения до размера окна даже маленьких изображений щелчком мыши
