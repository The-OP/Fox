...
Поддерживаемые на данный момент версии Firefox: **38.2.0 - 40**. <br>
**41 Beta** тоже поддерживается, но обновления могут быть не сразу после выпуска очередного билда. <br>
...
*[SSleuth](https://github.com/sibiantony/ssleuth) - показывает инфу об используемых криптопримитивах и фичах TLS/SSL в шифрованных соединениях.
