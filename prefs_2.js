// Объем RAM-кэша в килобайтах. По дефолту всего 5 МБ, так что полезно увеличить, если много памяти.
user_pref("browser.cache.memory.capacity", 524288);
// Максимальный объем одного элемента. Можно увеличить, чтобы видео помещалось целиком в память.
